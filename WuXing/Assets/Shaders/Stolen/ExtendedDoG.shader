        ...
        Pass {
            ...
            float4 fp(v2f i) : SV_Target {
                ...
                if (_Thresholding == 1) {
                    ...
                    float transitionWidth = 1.0f / (_Threshold * 0.1f);  // Adjusting the width based on _Threshold
                    float qs = smoothstep(-transitionWidth, transitionWidth, _Phi * (x - qn) * 10.0f) - 0.5f;
